...
//Delete Service
router.delete('/categories/category/:cid/company/:coid/service/:id/deleteService',function(req,res){
...
//create advertisment
router.post('/createAdvertisment', function(req, res, next) {
  var link = req.body.link;
  var path = req.body.path;
  var name = req.body.name;
  //var id = req.body.id;
     
    req.checkBody('link', 'link must be provided').notEmpty();
    req.checkBody('path', 'path must be provided').notEmpty();
